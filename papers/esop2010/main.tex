...
%<-> domain, region <-> key
%TODO the constants dealing with maps
...
\begin{abstract} We present a specification language suited for reasoning
  ...
  correctness of these and more examples.  \end{abstract}
...
arguments may be functions that have their own specification. In consequence,
...
programming language and the weakest precondition calculus.  In
section~\ref{sec:examples} we present our implementation and show some
...
aliasing, one would constantly need equalities and disequalities between
...
%TODO ref vers l'annexe -  remarque sur la difference
...
A prototype implementation of the presented system, called ``\who'',
 is freely available~\cite{KanigFilliatre09wml}%TODO \footnote
. It implements the
