...
module OP = Ocamlbuild_pack

(* these functions are not really officially exported *)
let run_and_read = OP.My_unix.run_and_read
let blank_sep_strings = OP.Lexers.blank_sep_strings
...
(*
        ...
        ~prods:["%.ml"; "%.mli"]
        ~dep:"%.mla" (fun env _build -> Cmd(S[A "alphaCaml"; P(env "%.mla")]));
*)
