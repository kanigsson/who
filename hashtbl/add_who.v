...
Section sec. (*who*)
  ...
  (*whoLis*) Require Import WhoList. (*who*) Admitted.Admitted.Admitted.
  (*whoHashtb*) Require Import WhoHashtbl. (*who*) (*whoa*) Variables a :
  Type. Variables r : key.  (*who*) 
  ...
  (*whoH*) Hypothesis H: 0 < (len (!! h s)).  (*who*) 
  (*whoH1*) Hypothesis H1:
            forall (i1:int),
            (0 <= i1) ->
            ((i1 < (len (!! h s))) ->
