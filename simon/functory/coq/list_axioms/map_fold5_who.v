...
Section sec. 
   Variable l:  list Z. 
  Lemma blih:
    ((@List_length  Z) l) < ((@List_length  Z) ((@Cons  Z) 1 l)). 
    Proof.
    assert (List_length (Cons 1 l) = List_length l + 1).
      ...
      assert (ind_list_len (1::l) (List_length l + 1)).
        apply (recur _ H).
        
      pose proof (list_length_ind (Cons 1 l) (List_length l+1)).
      destruct H1.
      symmetry. apply H1.
      assumption.
